      ...
      <div className="flex flex-col gap-12">
        <div className="flex flex-wrap items-center md:items-start gap-6 justify-center lg:justify-between">
          ...
          <div className="flex flex-col 2xs:flex-row items-center gap-6 ">
            ...
            <Link href="/createdebtors" className="bg-(--primaryColor)  px-5 py-3 rounded text-white flex gap-2 items-center justify-center shadow-[4px_4px_4px_0px_rgba(0,0,0,0.75)]">
              <Image
