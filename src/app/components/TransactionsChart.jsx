...
import { groupByMonth } from "../utils/calcTransactionsChart";
...
export default function TransactionsChart({ transactions }) {
  ...
  return (
    <div className="flex flex-col items-center pb-4 pt-6 md:py-6 pl-0 pr-6 gap-4 w-full h-72 justify-center rounded-lg shadow-[inset_4px_4px_2px_rgba(0,0,0,0.4),inset_-4px_-4px_2px_rgba(255,255,255)]">
      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        <LineChart data={data}>
          ...
          <Line type="monotone" dataKey="debt" strokeWidth={3} stroke="var(--quarternaryColor)" dot={{ fill: "var(--quarternaryColor)", r: 3 }} />
      ...
      <div className="flex flex-row w-full justify-center gap-5 text-xs font-semibold">
        <span className="text-(--quarternaryColor)"> - Debt</span>
