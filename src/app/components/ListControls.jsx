...
export default function ListControls({ search, setSearch, sort, setSort, sortOptions }) {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-3 w-full items-end">
      ...
      <input
        className="mx-0 md:mx-2 px-5 py-2 w-full min-w-60 rounded-md bg-(--background) focus:outline-(--tertiaryColor) shadow-[inset_3px_3px_2px_0_rgba(0,0,0,0.25)]"
        value={search}
      ...
      <div className="relative inline-block text-white h-10 rounded-md w-full lg:w-72 shadow-[4px_4px_4px_0px_rgba(0,0,0,0.75),-4px_-4px_4px_0px_rgba(255,255,255,0.75)]">
